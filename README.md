...
El endpoint `POST /api/v2/clientes/procesar/{id}` inicia el flujo entre las tres APIs.
...
El dashboard de Grafana Cloud está disponible en: `https://TU_WORKSPACE.grafana.net`
...
| Compañero 1 | API #2 — Podcasts | AWS |
| Compañero 2 | API #3 — Vehículos | AWS |

---

*Momento evaluativo: Abril 8 · Revisión: Abril 8 en clase*
